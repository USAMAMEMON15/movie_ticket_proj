				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Theater-<span id="nav">Show</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="theaters_add.php" id="nav">Theater Add</a></h5>
						</div>
					</div>
				</div>
			</section>
                    ...
                    <div class="col-lg-10 mx-auto p-5 ">
                        <div class="card bg-dark text-light">
                            <div class="card-header">
                                <h4 class="card-title">Theater Show</h4>
                            </div>
                        ...
                        <th>Delete</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="theaters_edit.php?id=<?php echo $row ['id']?>" class="btn   ">Edit</td>
                                                <td><a href="theaters_delete.php?id=<?php echo $row ['id']?>" class="btn ">Delete</td>
