				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Blog-<span id="nav">Show</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="blog_add.php" id="nav">Blog Add</a></h5>
						</div>
					</div>
				</div>
			</section>
                    ...
                    <div class="col-lg-10 mx-auto p-5 ">
                        <div class="card bg-dark text-light">
                            <div class="card-header">
                                <h4 class="card-title">Blog Show</h4>
                            </div>
...
<thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="blog_edit.php?id=<?php echo $row ['id']?>" class="btn ">Edit</td>
                                                <td><a href="blog_delete.php?id=<?php echo $row ['id']?>" class="btn r">Delete</td>
