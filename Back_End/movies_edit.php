				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Movies-<span id="nav">Edit</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="movies_show.php" id="nav">Movies Show</a></h5>
						</div>
					</div>
				</div>
			</section>
    ...
    <div class="row ">
        <div class="col-lg-8 m-auto">
            <div class="card  rounded-3 my-5 bg-dark  text-light">
                            <div class="card-header">
                                <h4 class="card-title">Movies Edit</h4>
                            </div>
                            <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group " >
                                            ...
                                            <input type="int" name="Duration" class="form-control bg-dark text-light  rounded-3 " placeholder="Duration">
                                        ...
                                        <div class="form-group " >
                                            ...
                                            <input type="text" name="Language" class="form-control bg-dark text-light  rounded-3 " placeholder="Language">
                                        </div>
                                        <div class="form-group" >
                                            <label class="text-dark">Release_Date</label>
                                            <input type="date" name="Release_Date" class="form-control bg-dark text-light  rounded-3 " placeholder="Release_Date">
                                        </div>
                                        <div class="form-group" >
                                            <label class="text-dark"> Image</label>
                                            <input type="file" name="image" class="form-control input-default bg-dark text-light  rounded-3 " placeholder="Image">
                                        </div>
                                        <div class="form-group" >
                                            <label class="text-dark">Trailer</label>
                                            <input type="file" name="trailer" class="form-control input-default bg-dark text-light  rounded-3 " placeholder="Trailer">
                                        </div>
                                         <button type="submit" name="update" class="btn my-2 mx-0">Add Movies</button>
                                    </form>  
...
if (isset($_POST['update'])){
    ...
    $sql = "update movies set title = '$Title' ,description = '$Discription' ,duration_min = '$Duration' ,category = '$Category' ,language = '$Language' ,release_date = '$Release_Date' ,image = '$image' , trailer = '$trailer' where id = $id";
