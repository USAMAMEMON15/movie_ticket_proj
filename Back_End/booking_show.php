...
$sql ="select bookings .* , users.id , shows.id from bookings inner join users on bookings.name = users.id inner join shows on bookings.title = shows.id";
				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Booking-<span id="nav">Show</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> </h5>
						</div>
					</div>
				</div>
			</section>
                    ...
                    <div class="col-lg-10 mx-auto p-5 ">
                        <div class="card bg-dark text-light">
                            <div class="card-header">
                                <h4 class="card-title">Booking Show</h4>
                            </div>
