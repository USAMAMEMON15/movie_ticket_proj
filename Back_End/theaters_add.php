				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Theater-<span id="nav">Add</span> </h1>
        ...
        <div class="col-lg-8 m-auto">
            <div class="card  rounded-3 my-5 bg-dark  text-light">
                            <div class="card-header">
                                <h4 class="card-title">Theater Add</h4>
                            </div>
                            <div class="card-body">
...
<form action="" method="POST">
          ...
          <button type="submit" name="submit" class="btn my-2">Add Theater</button>
        </form>
                                </div>
                            </div>
                        </div>
