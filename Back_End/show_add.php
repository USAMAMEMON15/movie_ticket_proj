				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Show-<span id="nav">Add</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="show_shows.php" id="nav">Shows Show</a></h5>
						</div>
					</div>
				</div>
			</section>
        ...
        <div class="col-lg-8 m-auto">
            <div class="card  rounded-3 my-5 bg-dark  text-light">
                            <div class="card-header">
                                <h4 class="card-title">Shows Add</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="post">
                                        ...
                                        <button type="submit" name ="submit" class="btn my-2 mx-0">Show add</button>
                                    </form>
...
if(isset($_POST['submit'])){
    ...
    $sql ="insert into shows (movie_id , screen_id , show_time,ticket_price) values ('$movie_id' , '$screen_id' , '$show_time' ,'$ticket_price')";
    $result = $conn->query($sql);
