...
if (isset($_POST['submit'])) {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        // Insert new user securely used prepare statement
...
<head>
    ...
    <style>
body{
            background:url("images/movies/img1.avif");
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form id="Form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="display-6">
                                           <a> <button type="submit" name="submit"   href="./login.php" class="btn btn-outline-primary mt-2">Sign up</button> </a>
                                        </div>
                                    </form>
