				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Blog-<span id="nav">Edit</span> </h1>
...
<form method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="update" class="btn my-2 mx-0">Add Blogs</button>
                    </form>
...
if (isset($_POST['update'])) {
    ...
    $sql = "update blog set title = '$Title' ,discription = '$Discription' ,category = '$Category'  ,date = '$Date', image = '$Image' where id = $id";
