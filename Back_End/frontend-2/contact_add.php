...
<style>
	/* ----------------------------------------------
* Generated by Gradienty on 2025-08-15 14:52
* animation scale-up-hor-left-normal
* ----------------------------------------
*/
...
<nav class="navbar navbar-expand-md navbar-light px_4" id="navbar_sticky">
 ...
 <div class="container-xl">
  <div class="row centre_o1 text-center">
    <div class="col-md-12">
      <h1 class="text-white font_60 focus-in-contract-normal">Contact Us</h1>
	  <h5 class="mb-0 mt-3 fw-normal col_oran focus-in-contract-normal"><a class="text-light focus-in-contract-normal" href="index.php">Home</a> <span class="mx-2 text-muted">/</span> Contact Us</h5>
   </div>
  </div>
 </div>
</section>
...
<section id="contact" class="p_3 scale-up-ver-buttom-normal">
 <div class="container-xl">
		<div class="row trend_1 text-center mb-4">
		<div class="col-md-12">
		<span class="fa fa-film col_oran"></span>
		<h6 class="text-muted mt-3">Contact With Us</h6>
		<h1 class="mb-0 font_50 scale-up-hor-left-normal">Feel Free to Write us <br>
		Anytime</h1>
		</div>
		</div>
		</div>
                        ...
                        <div  class="row no-gutters">
                            <div  class="col-xl-12">
                                <div  class="auth-form">
                                    ...
                                    <form class="scale-up-ver-buttom-normal" action="" method="post" enctype="multipart/form-data">
