...
<style>
	/* ----------------------------------------------
* Generated by Gradienty on 2025-08-15 14:54
...
<nav class="navbar navbar-expand-md navbar-light px_4" id="navbar_sticky">
  <div class="container-fluid">
			...
			<section id="center" class="centre_o  pt-5 pb-5">
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							<h1 class="text-white font_60 focus-in-contract-normal ">Movies</h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran focus-in-contract-normal"><a class="focus-in-contract-normal text-light" href="index.php">Home</a> <span class="mx-2 text-muted">/</span> Movies</h5>
						</div>
					</div>
				</div>
			</section>
	...
	<section class="tiles py-5 scale-up-ver-buttom-normal">
  <div class="container">
    <div class="row">
      <?php
