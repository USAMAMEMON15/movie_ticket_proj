				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Movies-<span id="nav">Show</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="movies_add.php" id="nav">Movies Add</a></h5>
						</div>
					</div>
				</div>
			</section>
                    ...
                    <div class="col-lg-12 mx-auto p-5 ">
                        <div class="card bg-dark text-light">
                            <div class="card-header">
                                <h4 class="card-title">Movies Show</h4>
                            </div>
                                       ...
                                       <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                echo"<td><img src=\"./images/movies/${row['image']}\" height=200px width=200px/></td>";
                                                
                                                ?>
                                                 <?php

                                                echo"<td><video src=\"./images/movies/${row['trailer']}\" height=200px width=200px/></td>";
                                                
                                                ?>
                                                <td><a href="movies_edit.php?id=<?php echo $row ['id']?>" class="btn ">Edit</td>
                                                <td><a href="movies_delete.php?id=<?php echo $row ['id']?>" class="btn ">Delete</td>
