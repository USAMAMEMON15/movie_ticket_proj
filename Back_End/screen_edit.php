				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Screen-<span id="nav">Edit</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="screen_show.php" id="nav">Screen Show</a></h5>
						</div>
					</div>
				</div>
			</section>
        ...
        <div class="col-lg-8 m-auto">
            <div class="card  rounded-3 my-5 bg-dark  text-light">
                            <div class="card-header">
                                <h4 class="card-title">Screen Edit</h4>
                            </div>
                            <div class="card-body">
                        ...
                        <form method="post">
                                        <div class="form-row">
                                            <div class="form-group col-md-12 text-dark">
                                                <label>Theater</label>
                                                <select id="inputState" class="form-control bg-dark text-light  rounded-3" name="u_r_id">
                                                   <?php
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12 text-dark pt-3">
                                                <label>Screen Name</label>
                                                <input type="text" class="form-control bg-dark text-light  rounded-3" name ="name" placeholder="Screen Name">
                                            </div>
                                            <div class="form-group col-md-12 text-dark pt-3">
                                                <label>Total Seats</label>
                                                <input type="number" name ="seats" class="form-control bg-dark text-light  rounded-3" placeholder="Total Seats">
                                            </div>
                                        
                                        </div>
                                     
                                        <button type="submit" name ="submit" class="btn my-2 mx-0">Screen add</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
if(isset($_POST['update'])){
    ...
    $name = $_POST['name'];
    $seats = $_POST['seats'];
    $theater_id  = $_POST['u_r_id'];
    $sql ="update screens set screen_name = '$name',total_seats = '$seats',theater_id = '$theater_id' where id = $id";
    $result = $conn->query($sql);
    ...
    if($result == true){
        ...
        <script>
        Swal.fire({
            title: 'Screen Edit Successfully!',
            icon: 'success',
            showConfirmButton: false,
            timer: 2000,
            didClose: () => {
                window.location.href = 'screen_shows.php';
            }
        });
        </script>";
    }
