				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">User-<span id="nav">Show</span> </h1>
							<h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Dash-Board</a> <span class="mx-2 text-light">/</span><a href="user_add.php" id="nav">User Add</a></h5>
						</div>
					</div>
				</div>
			</section>
                                    ...
                                    <table class="table table-bordered table-responsive-sm bg-dark text-light text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="user_edit.php?id=<?php echo $row['id']?>" class="btn ">Edit</a></td>
                                                <td><a href="user_delete.php?id=<?php echo $row['id']?>" class="btn ">Delete</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
