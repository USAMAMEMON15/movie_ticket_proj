				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Screen-<span id="nav">Add</span> </h1>
        ...
        <div class="col-lg-8 m-auto">
            <div class="card  rounded-3 my-5 bg-dark  text-light">
                            <div class="card-header">
                                <h4 class="card-title">Screen Add</h4>
                            </div>
                            <div class="card-body">
...
if(isset($_POST['submit'])){
    ...
    $sql ="insert into screens (theater_id ,screen_name , total_seats  ) values ( '$theater_id' ,'$name' , '$seats' )";
    $result = $conn->query($sql);
if($result == true){
