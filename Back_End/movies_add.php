				...
				<div class="container-xl">
					<div class="row centre_o1 text-center">
						<div class="col-md-12">
							...
							<h1 class="text-white font_50">Movies-<span id="nav">Add</span> </h1>
    ...
    <div class="row ">
        <div class="col-lg-8 m-auto">
            <div class="card  rounded-3 my-5 bg-dark  text-light">
                            <div class="card-header">
                                <h4 class="card-title">Movies Add</h4>
                            </div>
                            <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group" >
                                         ...
                                         <button type="submit" name="submit" class="btn my-2 mx-0">Add Movies</button>
                                    </form>  
...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into movies (title,description,duration_min,category,language,release_date,image,trailer) values('$Title' , '$Discription', '$Duration', '$Category', '$Language', '$Release_Date', '$image','$trailer')";
